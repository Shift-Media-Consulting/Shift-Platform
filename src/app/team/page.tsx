...
const founders = [
  {
    ...
    bio: 'Justin built his career in production controlling — the discipline that sits between the brief, the budget, and the final bill. He has worked across German-speaking markets for over a decade, running cost control on campaigns from local brand work to international co-productions. He founded SHIFT to give brands what he rarely found in the market: an independent read, with no production-side upside.',
